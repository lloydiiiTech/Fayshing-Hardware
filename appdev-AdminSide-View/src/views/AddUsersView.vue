      ...
      <div class="row">
        <div class="col text-center mb-3">
          ...
          <div class="img-preview">
            <img :src="imageUrl || defaultImage" alt="Profile Picture" class="rounded-circle img-fluid" style="width: 100px; height: 100px; border: 2px solid #e79224;" />
          </div>
...
export default {
  ...
  methods: {
    ...
    async addStaff() {
      ...
      try {
  const response = await axios.post('http://localhost:5000/admin/addstaff', staffData);
